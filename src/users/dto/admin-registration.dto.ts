...
export class AdminRegistrationDto {
  ...
  @ApiProperty({
    ...
    enum: AuthorityNameEnum,
    example: AuthorityNameEnum.EMPLOYEE,
  })
  @IsNotEmpty({ message: 'Роль должна быть назначена' })
  @IsEnum(AuthorityNameEnum, { message: 'Некорректня роль' })
